...
class Preconditioner:
    ...
    def __init__(self, backend, system, *, krylov_eps=0, pcdtype=None):
        self.backend = backend
        self.system = system

    def init_matrices(self, ext):
        pass
...
class BlockJacobiPreconditioner(Preconditioner):
    ...
    def __init__(self, backend, system, *, krylov_eps, pcdtype):
        super().__init__(backend, system, krylov_eps=krylov_eps,
                         pcdtype=pcdtype)
        self._krylov_eps = krylov_eps
    ...
    def construct(self, t, u_reg, gamma_dt, rhs_fn, f0_reg, up_reg, add_fn,
        ...
        self._eeps = tuple(self._krylov_eps*s for s in self._escales)
